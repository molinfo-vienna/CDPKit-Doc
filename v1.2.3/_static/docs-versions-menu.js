...
function _addVersionsMenu(version_data) {
    ...
    if (version_data["labels"][current_folder] === undefined) current_folder = '.';
    ...
    for (i in folders) {
        ...
        if (folder == current_folder){
            ...
            if (current_folder == '.')
                var url = current_url.replace(root_url, root_url + '/' + folder);
            else if (folder == '.')
                var url = current_url.replace(current_folder + '/', '');
            else
                var url = current_url.replace(current_folder, folder);
            
            var inner_html = inner_html + "<dd><a href='"
                + url + "'>" + version_data["labels"][folder] + "</a></dd>";
        }
    }
